    ...
    <section class="tp-postbox-area pt-120 pb-120">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
{{--                            <img src="https://shirecityb.com/img/4.png" class="card-img-top" alt="...">--}}
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card">
{{--                            <img src="https://shirecityb.com/img/5.png" class="card-img-top" alt="...">--}}
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card">
{{--                            <img src="https://shirecityb.com/img/6.png" class="card-img-top" alt="...">--}}
                            <div class="card-body">
