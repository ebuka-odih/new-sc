                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('admin.storeFund') }}" method="POST" >
                                @csrf
                                ...
                                <div class="col-lg-6">
                                    <label for="example-ltf-text">Transaction Date</label>
                                    <input type="date" class="form-control form-control-lg" id="example-if-password" name="created_at" >
                                </div>
                                <div class="col-lg-6">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group">
                                                                ...
                                                                <form method="POST" action="{!! route('admin.deleteFund', $item->id) !!}" accept-charset="UTF-8">
