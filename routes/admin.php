...
Route::group(['middleware' => ['auth', 'admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('update/transfer/date/{id}', 'Admin\AdminTransactions@updateDate')->name('updateDate');
    ...
    Route::get('add/fund', "Admin\AdminFundingController@addFund")->name('addFund');
    Route::post('add/fund', "Admin\AdminFundingController@storeFund")->name('storeFund');
    Route::delete('delete/fund/{id}', "Admin\AdminFundingController@deleteFund")->name('deleteFund');
