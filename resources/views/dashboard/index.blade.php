                ...
                <div class="row text-center">
                    <div class="col-md-4 py-3">
                        <div class="fs-1 fw-light text-dark mb-1">
                            @convert(auth()->user()->account->balance) <small style="font-size: 12px" class="badge bg-info">{{ $user->preferred_currency ?? 'USD' }}</small>
                        </div>
                    ...
                    <div class="col-md-4 py-3">
                        <div class="fs-1 fw-light text-success mb-1">
                            +@convert($credit) <small style="font-size: 12px" class="badge bg-info">{{ $user->preferred_currency ?? 'USD' }}</small>
                        </div>
                    ...
                    <div class="col-md-4 py-3">
                        <div class="fs-1 fw-light text-danger mb-1">
                            -@convert($debit) <small style="font-size: 12px" class="badge bg-info">{{ $user->preferred_currency ?? 'USD' }}</small>
                        </div>
                    ...
                    @if($item->from == optional(auth()->user()->account)->account_number)
                        <a class="block block-rounded block-link-shadow border-start border-success border-3" href="{{ route('user.nsb_withdrawal_details', $item->id) }}">
                            <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <p class="fs-lg fw-semibold mb-0">
                                        -@convert($item->amount) {{ $user->preferred_currency ?? 'USD' }}
                                    </p>
                                    <p class="text-muted mb-0">
