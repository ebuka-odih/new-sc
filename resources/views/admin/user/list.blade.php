                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons dataTable no-footer" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sorting" style="width: 15%;" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Access: activate to sort column ascending">Status</th>
                                        ...
                                        @foreach($users as $item)
                                            <tr class="odd">
                                                ...
                                                <td class="fw-semibold"> {!! $item->status() !!} </td>
...
{{--                                                            </a>--}}
{{--                                                        @else--}}
{{--                                                            <a href="{{ route('admin.suspendUser', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Approve User" data-bs-original-title="Edit">--}}
