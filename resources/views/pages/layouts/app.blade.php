...
{{--    <script type="text/javascript" src="http://cdn.rlets.com/capture_configs/d29/0b8/81e/9be465d9e8e418754401c3e.js" async="async"></script>--}}
    ...
    <title>{{ env('APP_NAME') }} | Personal &amp; Business Banking </title>
    <meta name="description" content="Experience personalized banking with a local touch" />
{{--    <link rel="canonical" href="index.html" />--}}
{{--    <meta property="og:locale" content="en_US" />--}}
{{--    <meta property="og:type" content="website" />--}}
{{--    <meta property="og:title" content="{{ env('APP_NAME') }} | Personal &amp; Business Banking in Colorado &amp; New Mexico" />--}}
...
{{--    <meta property="og:site_name" content="{{ Date('APP_NAME') }}" />--}}
...
{{--                <h3 style="color: black">Shirecity</h3>--}}
                <img style="height: 100px; width: 100px" src="{{ asset('img/logo.png') }}" alt="">
            ...
            <div class="footer-top">
                ...
                <div class="footer-col footer-col4">
                    ...
                    <div><p><a >Locations</a></p>
                        <p>Email <a href="mailto:info@shirecity.com">info@shirecity.com</a></p>
                        <p>{{ env('APP_NAME') }} Routing Number</p>
                        <p>102200245</p>
                    </div>
                </div>
