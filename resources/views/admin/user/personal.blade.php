   ...
   <div class="card">
       ...
       <div class="content content-full content-boxed">
           ...
           <div class="container mt-5">
               <form action="{{ route('admin.userStatus', $user_details->id) }}" method="POST">
                   @csrf
                   ...
                   @endif
                   <h4>Current User Status {!! $user_details->status() !!}</h4>
                   <div class="col-md-6">
           ...
           <div class="row">
               ...
               <table class="table table-striped" style="width:100%">
                   ...
                   <tr>
                       <th>Base Currency:</th>
                       <td>{{ $user_details->preferred_currency ?? 'USD' }}</td>
                   </tr>
                   <tr>
           ...
           <form action="{{ route('admin.updateUserDate', $user_details->id) }}" method="POST">
               ...
               <div class="form-group">
                   <input type="date" name="created_at" class="form-control col-lg-8">
               </div>
