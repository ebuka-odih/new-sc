    ...
    <main id="main-container">
        ...
        <div class="content">
             <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('user.withdrawHistory') }}">Outflow Transactions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.inflowHistory') }}">Inflow Transactions</a>
                    </li>
                </ul>
            ...
            <h2 class="content-heading">
                <i class="fa fa-angle-right text-muted me-1"></i> Outflow History
            </h2>
